...
<template>
    ...
    <AuthenticatedLayout :category="category">
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">{{ category.title }}</h2>
        </template>

        <section class="bg-gray-100 text-gray-400 dark:bg-gray-900">
            <div class="mx-auto max-w-9xl px-4 py-12 sm:px-6 lg:px-8">
