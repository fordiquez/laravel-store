        ...
        <div class="bg-white">
            <div class="pt-6">
                <nav aria-label="Breadcrumb">
                    <ol role="list" class="mx-auto flex max-w-7xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <!-- Image gallery -->
                <div class="mx-auto mt-6 max-w-7xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
                ...
                <!-- Product info -->
                <div class="mx-auto max-w-7xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
                    ...
                    <div class="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="flex items-center">
                                <div class="flex items-center">
                                    <font-awesome-icon icon="fa-solid fa-star" v-for="rating in [0, 1, 2, 3, 4]" :key="rating" :class="[reviews.average > rating ? 'text-gray-900' : 'text-gray-200', 'h-5 w-5 flex-shrink-0']" aria-hidden="true" />
                                </div>
