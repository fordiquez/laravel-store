...
<template>
    <Link :href="href" :class="[classes, 'block w-full pl-3 pr-4 py-2 border-l-4 text-left text-base font-medium focus:outline-none transition duration-150 ease-in-out']">
        <slot />
    </Link>
</template>
