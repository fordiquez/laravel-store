    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\SpatieMediaLibraryImageColumn::make('preview')->collection('goods'),
                Tables\Columns\TextColumn::make('category.title')->limit(25)->sortable(),
                Tables\Columns\TextColumn::make('brand.name')->limit(25)->sortable(),
                Tables\Columns\TextColumn::make('title')->limit(25)->sortable()->searchable(),
                Tables\Columns\TextColumn::make('old_price')->sortable(),
